...
Watch from the point that the video starts to 7:33 in order to see how to set up the pathfinding grid, as well as how to change the settings for the melee enemy pathfinding behavior.
...
The OnCollisionStay2D function in PistolEnemy.cs is overriding the function found in Enemy.cs. This is done because I made these enemies with the intention that they could not deal damage
from running into their targets. Remove the override function in PistolEnemy.cs if you would like for them to deal melee damage as well as ranged damage.
...
Be sure to read the comments left in the code to fully understand how the melee enemy functions.
